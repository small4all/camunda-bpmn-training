package com.small.camunda_ejb_example;
...
public class ArquillianTest {
  ...
  private static final String PROCESS_DEFINITION_KEY = "camunda-ejb-example";
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "camunda-ejb-example.war")
            ...
            .addPackages(false, "com.small.camunda_ejb_example") // not recursive to skip package 'nonarquillian'
